      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex gap-2 pt-2">
          <button
            ...
            className="flex-1 px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg font-medium text-xs transition-all duration-200 border border-slate-200"
          >
            {copyStatus === 'colors' ? '✓ Cores Copiadas!' : 'Copiar Cores'}
          </button>
          <button
            onClick={handleCopyClasses}
            className="flex-1 px-3 py-2 bg-slate-800 hover:bg-slate-900 text-white rounded-lg font-medium text-xs transition-all duration-200"
          >
            {copyStatus === 'classes' ? '✓ Classes Copiadas!' : 'Copiar Classes'}
          </button>
        </div>
      </div>
    </div>
